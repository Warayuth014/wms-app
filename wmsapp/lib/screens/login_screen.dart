                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ...List.generate(_users.length, (i) {
                            ...
                            return Padding(
                              padding: EdgeInsets.only(bottom: i < _users.length - 1 ? 8 : 0),
                              child: Material(
                                color: isSelected
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: isSelected
                                                ? AppTheme.primary
                                                : AppTheme.textGrey(context).withValues(alpha: 0.1),
                                            borderRadius: BorderRadius.circular(AppTheme.radiusSm),
                                          ),
                                          child: Icon(
                          ...
                          Center(
                            child: Text(
                              'รหัสผ่านทดสอบ: 1234',
                              style: TextStyle(
                                color: AppTheme.textGrey(context).withValues(alpha: 0.6),
                                fontSize: 12,
                              ),
                            ),
                          ),
